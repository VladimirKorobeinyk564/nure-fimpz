...
import TheoreticalInformation
    from "@/components/pages/docs/content/lb/lb-1/theoretical-information/theoretical-information.tsx";
import UsingOpenjml from "@/components/pages/docs/content/lb/lb-1/using-openjml/using-openjml.tsx";
import TestingCustomizedUtility
    from "@/components/pages/docs/content/lb/lb-1/testing-customized-utility/testing-customized-utility.tsx";
...
import VariantsIndividualTasks
    from "@/components/pages/docs/content/lb/lb-1/variants-individual-tasks/variants-individual-tasks.tsx";
