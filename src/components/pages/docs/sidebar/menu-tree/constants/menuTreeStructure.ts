        ...
        nodes: [
            {
                ...
                path: 'pz-1',
                isNavigate: true,
                parentKey: 'c6a7b20a-4498-4e37-bc5e-810fcf76d2ab',
                nodes: [
                    {
        ...
        nodes: [
            {
                ...
                path: 'lb-1',
                isNavigate: true,
                parentKey: 'e53a83c9-7d28-4d46-a249-9b35829251a6',
                nodes: [
                    {
                        ...
                        path: null,
                        isNavigate: true,
                        parentKey: '6b82623b-b139-4f63-b6e3-d84e1b02c132',
                        nodes: []
                    },
                ],
            },
        ...
        nodes: [
            {
                ...
                path: 'python-lesson',
                isNavigate: true,
                parentKey: '47a16012-967e-48d6-bf5e-49a9f33f81ec',
                nodes: [
                    {
